...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="home">Fashion Clothes</a>
        <button
...
<!--            <div class="d-flex my-2">
                <form class="btn btn-outline-dark" action="cart" method="post">
                    <button onclick="cart()"><i class="bi-cart-fill me-1"></i>
                    Cart
